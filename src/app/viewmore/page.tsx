...
const categoryConfig = {
  "Now Playing": {
    ...
    badge: "Now Playing",
    description:
      "Currently showing in theaters. Catch these movies on the big screen today!",
  ...
  Upcoming: {
    ...
    badge: "Upcoming",
    description:
      "Get ready for the most anticipated releases coming soon to theaters. Mark your calendar for these exciting new films.",
  ...
  Popular: {
    ...
    badge: "Popular",
    description:
      "The most popular movies right now. See what everyone is watching and talking about.",
  ...
  "Top Rated": {
    ...
    badge: "Top Rated",
    description:
      "The highest-rated movies of all time. Experience cinema at its finest with these critically acclaimed masterpieces.",
